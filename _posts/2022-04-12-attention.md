...
**Multi-head attention** uses multiple attention functions. Each one will compute its own attention; then, we concatenate them to get our final context vector.
